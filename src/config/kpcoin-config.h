/* src/config/kpcoin-config.h.  Generated from kpcoin-config.h.in by configure.  */
/* src/config/kpcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "KPCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KPCoin Core 27.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kpcoin"
