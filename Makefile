...
pkgdatadir = $(datadir)/kpcoin
pkgincludedir = $(includedir)/kpcoin
pkglibdir = $(libdir)/kpcoin
pkglibexecdir = $(libexecdir)/kpcoin
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/pkg.m4 $(top_srcdir)/configure.ac
...
CONFIG_HEADER = $(top_builddir)/src/config/kpcoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/kpcoin-config.h.in \
...
ACLOCAL = ${SHELL} '/home/kp/kpcoin/build-aux/missing' aclocal-1.18
AMTAR = $${TAR-tar}
...
ARM_SHANI_CXXFLAGS = 
AS = as
AUTOCONF = ${SHELL} '/home/kp/kpcoin/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/home/kp/kpcoin/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/home/kp/kpcoin/build-aux/missing' automake-1.18
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/home/kp/kpcoin/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = KPCoin Core
PACKAGE_STRING = KPCoin Core 27.0.0
PACKAGE_TARNAME = kpcoin
...
XGETTEXT = 
ZIP = 
ZMQ_CFLAGS = -isystem /usr/include/mit-krb5 -isystem /usr/include/mit-krb5 -I/usr/include/pgm-5.3 -I/usr/include/libxml2 -I/usr/include/x86_64-linux-gnu
ZMQ_LIBS = -lzmq
abs_builddir = /home/kp/kpcoin
abs_srcdir = /home/kp/kpcoin
abs_top_builddir = /home/kp/kpcoin
abs_top_srcdir = /home/kp/kpcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/kp/kpcoin/build-aux/install-sh
...
EXTRA_DIST = $(DIST_SHARE) $(DIST_CONTRIB) $(WINDOWS_PACKAGING) \
	...
	test/util/test_runner.py test/util/data/kpcoin-util-test.json \
...
src/config/kpcoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/kpcoin-config.h.in $(top_builddir)/config.status
	$(AM_V_at)rm -f src/config/stamp-h1
	$(AM_V_GEN)cd $(top_builddir) && $(SHELL) ./config.status src/config/kpcoin-config.h
$(top_srcdir)/src/config/kpcoin-config.h.in:  $(am__configure_deps) 
	$(AM_V_GEN)($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	$(AM_V_at)rm -f src/config/stamp-h1
	$(AM_V_at)touch $@

distclean-hdr:
	-rm -f src/config/kpcoin-config.h src/config/stamp-h1
